...
namespace NFeature.Configuration.Test.Slow
{
    ...
    public class FeatureConfigurationSectionTests
    {
        ...
        public void FeatureConfigurationSection_Retrieves_ArrayJsonSetting_OK() {
            var s = new ConfigurationManager<FeatureConfigurationSection<Feature, Tenant>, Feature, Tenant>().Section();
        ...
        [Test]
        public void FeatureConfigurationSection_Retrieves_FeatureState_OK_From_Feature2_Section_With_Tenant()
        {
            var s = new ConfigurationManager<FeatureConfigurationSection<Feature2, Tenant>, Feature2, Tenant>().Section();
            var f = s.FeatureSettings;
